...
let
  ...
  inherit (lib.kernel) yes no module unset freeform;
  ...
  hardenedConfig =
    import "${pkgs}/os-specific/linux/kernel/hardened/config.nix" {
      inherit lib version stdenv;
    };
in
{
  # TODO: check with nixpkgs/pkgs/os-specific/linux/kernel/hardened/config.nix
  archMap = {
    "i686" = "X86_32";
    "x86_64" = "X86_64";
    "aarch64" = "ARM64";
