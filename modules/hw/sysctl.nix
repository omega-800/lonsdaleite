  ...
  config = mkIf cfg.enable {
    boot.kernel.sysctl = mkMerge [
      ...
      })
      {
        ...
        # Reboot after even 1 WARN or BUG/Oops. Adjust for your tolerances. (Since v6.2) If you want to set oops_limit greater than one, you will need to disable CONFIG_PANIC_ON_OOPS.
        "kernel.warn_limit" = "1";
        # Reboot after even 1 WARN or BUG/Oops. Adjust for your tolerances. (Since v6.2) If you want to set oops_limit greater than one, you will need to disable CONFIG_PANIC_ON_OOPS.
        "kernel.oops_limit" = "1";
        ...
        "kernel.kptr_restrict" = mkLowerForce (if cfg.paranoia == 0 then "1" else "2");
        ...
        # logs. (this value can also be set by CONFIG_SECURITY_DMESG_RESTRICT).
        ...
        "kernel.yama.ptrace_scope" = if cfg.paranoia > 0 then "3" else "2";
        ...
        # line disciplines with the TIOCSETD ioctl. (see CONFIG_LDISC_AUTOLOAD)
        ...
        # For example, this can be set after the system has finished booting and initializing hardware: https://outflux.net/blog/archives/2009/07/31/blocking-module-loading/
