...
let
  ...
  inherit (lib)
    mkIf concatStringsSep concatMapStringsSep filterAttrs removeSuffix;
  ...
  kernelConfigs = {
    ...
    "RETPOLINE y" = [ "X86_32" "X86_64" ]; # 4.15-4.20, 5.0-5.17
    ...
    "# USB_USBNET is not set" = [
      ...
      "X86_32"
      "X86_64"
    ]; # 2.6.22-2.6.39, 3.0-3.19, 4.0-4.20, 5.0-5.17

    # Do not allow access to physical memory via /dev/mem
    "# DEVMEM is not set" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.0-4.20, 5.0-5.17
    ...
    */
    ...
    "DM_CRYPT m" = [
      ...
      "X86_32"
      "X86_64"
    ]; # 2.6.4-2.6.39, 3.0-3.19, 4.0-4.20, 5.0-5.17
    ...
    "PAGE_POISONING y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.6-4.20, 5.0-5.17
    ...
    "ARCH_HAS_ELF_RANDOMIZE y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.1-4.20, 5.0-5.17
    ...
    "INIT_ON_FREE_DEFAULT_ON y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 5.3-5.17
    ...
    */
    ...
    "INIT_STACK_ALL_ZERO y" = [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 5.9-5.17
    ...
    "STACKPROTECTOR y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.18-4.20, 5.0-5.17
    ...
    "STACKPROTECTOR_PER_TASK y" = [ "ARM" "ARM64" ]; # 5.0-5.17
    ...
    "GCC_PLUGIN_STACKLEAK y" = [ "ARM64" "X86_32" "X86_64" ]; # 5.2-5.17
    ...
    */
    ...
    "STRICT_KERNEL_RWX y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.11-4.20, 5.0-5.17
    ...
    "SLAB_FREELIST_HARDENED y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.14-4.20, 5.0-5.17
    ...
    "SLAB_FREELIST_RANDOM y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.7-4.20, 5.0-5.17
    ...
    "# INET_DIAG is not set" = [
      ...
      "X86_32"
      "X86_64"
    ]; # 2.6.14-2.6.39, 3.0-3.19, 4.0-4.20, 5.0-5.17
    ...
    */
    ...
    "HARDENED_USERCOPY y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.8-4.20, 5.0-5.17
    ...
    "# HARDENED_USERCOPY_FALLBACK is not set" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.16-4.20, 5.0-5.15
    ...
    */
    ...
    "X86_UMIP y" = [ "X86_32" "X86_64" ]; # 5.5-5.17
    ...
    */
    ...
    "RANDOMIZE_BASE y" = [ "ARM64" "X86_32" "X86_64" ]; # 4.7-4.20, 5.0-5.17
    ...
    "GCC_PLUGIN_RANDSTRUCT y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.13-4.20, 5.0-5.17
    ...
    */
    ...
    "# KEXEC_FILE is not set" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 3.17-3.19, 4.0-4.20, 5.0-5.17
    ...
    */
    ...
    "# MODULES is not set" = [ "ARM" "ARM64" "X86_32" "X86_64" ];
    ...
    "MODULE_SIG y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 3.7-3.19, 4.0-4.20, 5.0-5.17

    # Automatically sign all modules during modules_install (so we don’t have to do this manually)
    "MODULE_SIG_ALL y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 3.9-3.19, 4.0-4.20, 5.0-5.17
    ...
    */
    ...
    "# MODIFY_LDT_SYSCALL is not set" =
      [ "X86_32" "X86_64" ]; # 4.3-4.20, 5.0-5.17
    ...
    "# X86_VSYSCALL_EMULATION is not set" =
      [ "X86_32" "X86_64" ]; # 3.19, 4.0-4.20, 5.0-5.17
    ...
    */
    ...
    "SECURITY_YAMA y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 3.4-3.19, 4.0-4.20, 5.0-5.17
    ...
    "# SECURITY_WRITABLE_HOOKS is not set" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.12-4.20, 5.0-5.17
    ...
    "# SECURITY_SELINUX_DISABLE is not set" = [
      ...
      "X86_32"
      "X86_64"
    ]; # 2.6.6-2.6.39, 3.0-3.19, 4.0-4.20, 5.0-5.17
    ...
    "SECURITY_LOCKDOWN_LSM y" = [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 5.4-5.17

    # Enable lockdown LSM early in init
    "SECURITY_LOCKDOWN_LSM_EARLY y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 5.4-5.17
    ...
    "SECURITY_LOADPIN_ENFORCE y" =
      [ "ARM" "ARM64" "X86_32" "X86_64" ]; # 4.20, 5.0-5.17
    ...
    */
    ...
    "HARDEN_BRANCH_PREDICTOR y" = [ "ARM" "ARM64" ]; # 4.16-4.20, 5.0-5.17
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    environment.etc."modprobe.d/lonsdaleite-disable".text =
      concatMapStringsSep "\n" (s: "install ${s} /bin/false") disabled_modules;
  };
}
